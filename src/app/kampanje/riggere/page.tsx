...
import RiggereForm from '@/components/kampanje/RiggereForm';
...
export const metadata: Metadata = {
  title: 'Riggere til Offshore',
  description: 'Equinor investerer 100 milliarder. 4,000 nye årsverk på norsk sokkel. Søk jobb som offshore-rigger.',
  openGraph: {
    title: 'Riggere til Offshore',
...
export default function RiggereCampaignPage() {
  const stilling = OFFSHORE_STILLINGER.riggere;

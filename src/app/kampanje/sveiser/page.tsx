...
import SveiserForm from '@/components/kampanje/SveiserForm';
...
export const metadata: Metadata = {
  title: 'Sveisere til Offshore',
  description: 'Equinor investerer 100 milliarder. 4,000 nye årsverk på norsk sokkel. Søk jobb som offshore-sveiser.',
  openGraph: {
    title: 'Sveisere til Offshore',
    description: 'Massivt behov for sveisere på norsk sokkel.',
    type: 'website',
  },
  alternates: {
    canonical: 'https://bluecrew.no/kampanje/sveiser',
  },
  robots: {
    index: false,
    follow: false,
...
export default function SveiserCampaignPage() {
  const stilling = OFFSHORE_STILLINGER.sveiser;

...
import ROVForm from '@/components/kampanje/ROVForm';
...
export const metadata: Metadata = {
  title: 'ROV-Piloter til Offshore',
  description: 'Equinor investerer 100 milliarder. 4,000 nye årsverk på norsk sokkel. Søk jobb som ROV-pilot.',
  openGraph: {
    title: 'ROV-Piloter til Offshore',
...
export default function ROVCampaignPage() {
  const stilling = OFFSHORE_STILLINGER.rov;

...
import ETOForm from '@/components/kampanje/ETOForm';
...
export const metadata: Metadata = {
  title: 'ETO til Offshore',
  description: 'Equinor investerer 100 milliarder. 4,000 nye årsverk på norsk sokkel. Søk jobb som ETO.',
  openGraph: {
    title: 'ETO til Offshore',
...
export default function ETOCampaignPage() {
  const stilling = OFFSHORE_STILLINGER.eto;

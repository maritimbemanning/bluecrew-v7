...
import MekanikerForm from '@/components/kampanje/MekanikerForm';
...
export const metadata: Metadata = {
  title: 'Mekanikere til Offshore',
  description: 'Equinor investerer 100 milliarder. 4,000 nye årsverk på norsk sokkel. Søk jobb som offshore-mekaniker.',
  openGraph: {
    title: 'Mekanikere til Offshore',
...
export default function MekanikerCampaignPage() {
  const stilling = OFFSHORE_STILLINGER.mekaniker;

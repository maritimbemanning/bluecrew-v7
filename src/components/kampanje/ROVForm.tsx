...
const schema = z.object({
  ...
  rovRolle: z.string().min(1, 'Velg ROV-rolle'),
...
export default function ROVForm() {
    ...
    <div className="bg-navy-800/80 backdrop-blur-sm border border-cream-100/10 rounded-2xl p-4 md:p-6">
      <div className="text-center mb-4">
        ...
        <p className="text-cream-100/70 text-sm mt-1">
          Remotely Operated Vehicle - Offshore
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
        ...
        <div>
          <label className="block text-xs text-cream-100/80 mb-1">
            Hvilken ROV-rolle? <span className="text-gold-400">*</span>
          </label>
          <select
            {...register('rovRolle')}
            className="w-full bg-navy-700/50 border border-cream-100/20 rounded-lg
          ...
          >
            ...
            <option value="pilot" className="bg-navy-800">ROV Pilot/Senior</option>
            <option value="supervisor" className="bg-navy-800">ROV Supervisor</option>
            <option value="tekniker" className="bg-navy-800">ROV Technician</option>
            <option value="trainee" className="bg-navy-800">ROV Trainee</option>
          </select>
          {errors.rovRolle && (
            <p className="text-red-400 text-xs mt-1">{errors.rovRolle.message}</p>
          )}
        </div>
        ...
        <div>
          <label className="block text-xs text-cream-100/80 mb-1">
            Erfaring med ROV <span className="text-gold-400">*</span>
          </label>
          <select
            {...register('erfaring')}
            className="w-full bg-navy-700/50 border border-cream-100/20 rounded-lg

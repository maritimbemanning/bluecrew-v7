  ...
  return (
    <div className="bg-navy-800/80 backdrop-blur-sm border border-cream-100/10 rounded-2xl p-4 md:p-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
        ...
        {/* Offshore-erfaring type */}
        <div>
          <label className="block text-xs text-cream-100/80 mb-1">
            Type offshore-rolle <span className="text-gold-400">*</span>
          </label>
          <select
          ...
          >
            ...
            <option value="olje-gass" className="bg-navy-800">Olje & gass</option>
            <option value="havvind" className="bg-navy-800">Havvind</option>
            <option value="bore" className="bg-navy-800">Borerigger</option>
            <option value="installasjon" className="bg-navy-800">Installasjoner</option>
            <option value="annet" className="bg-navy-800">Annet offshore</option>
          </select>
        ...
        <div>
          <label className="block text-xs text-cream-100/80 mb-1">
            Fagområde/stilling (frivillig)
          </label>
          <input
            type="text"
            placeholder="Ex: Mekaniker, Kokk, Elektro..."
            {...register('fagomrade')}
            className="w-full bg-navy-700/50 border border-cream-100/20 rounded-lg
                       text-cream-50 placeholder:text-cream-100/40 text-sm
                       py-2.5 px-3 focus:border-gold-400 focus:outline-none
